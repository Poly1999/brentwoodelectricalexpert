    ...
    <div className='servicessection'>
      <div className='container'>
        ...
        <div className='servicessection_list'>
          {/* Картка 1 — Panel Upgrades (картинка зліва) */}
          <div className='servicecard'>
            ...
            <div className='servicecard_content'>
              ...
              <p className='servicecard_text'>
                Is your electrical panel outdated, overloaded, or unable to keep
                up with modern demands? Brentwood Electrical Experts provides
                professional electrical panel upgrades across West LA, Santa
                Monica, Brentwood, and surrounding communities. We upgrade
                100-amp panels to 200-amp or...
              </p>
              ...
              <a href='/services/panel-upgrades' className='servicecard_link'>
          ...
          {/* Картка 2 — Construction (картинка справа) */}
          <div className='servicecard servicecard_reverse'>
            <div className='servicecard_content'>
              ...
              <a href='/services/construction' className='servicecard_link'>
          ...
          {/* Картка 3 — Subpanels (картинка зліва) */}
          <div className='servicecard'>
            <div className='servicecard_image'>
            ...
            <div className='servicecard_content'>
              ...
              <div className='servicecard_features'>
                ...
                <div className='servicecard_feature'>
                  <CheckCircle2 />
                  <span>Code-compliant installation with proper grounding</span>
                </div>
              </div>
              <a href='/services/subpanels' className='servicecard_link'>
                Explore Subpanels
                <ArrowRight />
              </a>
            </div>
          ...
          {/* Картка 4 — Security Cameras (картинка справа) */}
          <div className='servicecard servicecard_reverse'>
            <div className='servicecard_content'>
              <div className='servicecard_label'>
                <div className='servicecard_icon'>
              ...
              <a href='/services/security-cameras' className='servicecard_link'>
          ...
          {/* Картка 5 — Security Lighting (картинка зліва) */}
          <div className='servicecard'>
            <div className='servicecard_image'>
              <img
            ...
            <div className='servicecard_content'>
              ...
              <div className='servicecard_features'>
                ...
                <div className='servicecard_feature'>
                  <CheckCircle2 />
                  <span>Illuminate driveways, pathways, and entry points</span>
                </div>
                <div className='servicecard_feature'>
                  <CheckCircle2 />
          ...
          {/* Картка 6 — Outlets & GFCI (картинка справа) */}
          <div className='servicecard servicecard_reverse'>
            <div className='servicecard_content'>
              <div className='servicecard_label'>
                <div className='servicecard_icon'>
              ...
              <p className='servicecard_text'>
                ...
                Experts installs and upgrades electrical outlets throughout West
                LA. We ensure every installation meets current NEC code
              ...
              <a href='/services/outlets-gfci' className='servicecard_link'>
          ...
          {/* Картка 7 — Light Fixtures (картинка зліва) */}
          <div className='servicecard'>
            <div className='servicecard_image'>
              <img src={LightFixturesImage} alt='Light Fixture Installation' />
            </div>
            <div className='servicecard_content'>
              <div className='servicecard_label'>
                <div className='servicecard_icon'>
              ...
              <p className='servicecard_text'>
                ...
                handles all light fixture installations across Brentwood, Santa
                Monica, Beverly Hills, and West Los Angeles.
              </p>
              <div className='servicecard_features'>
                <div className='servicecard_feature'>
                  <CheckCircle2 />
              ...
              <a href='/services/light-fixtures' className='servicecard_link'>
        ...
        <div className='servicessection_viewall'>
          <a href='/services' className='servicessection_viewall_button'>
            View All Services
            <ArrowRight />
          </a>
        </div>
